...
class agendaGoogleDrive
{
	...
	public function __construct()
	{
		...
		{
			$this->log->LogInfo("agendaGoogleDrive.class - Access Token Expired");	
	...
	{ 
		...
		$this->log->LogInfo("agendaGoogleDrive.class - createFolder: SUCCESS ".$title);
	...
	public function deleteFolder($id)
	{
		...
		$this->log->LogInfo("adjuntoGoogleDrive.class - deleteFolder: SUCCESS");
	}
	...
	public function updateFolder($id,$title)
	{
		...
		$this->log->LogInfo("agendaGoogleDrive.class - updateFolder: SUCCESS ".$id);
	}
	...
	{	
		...
		$this->log->LogInfo("agendaGoogleDrive.class - saveUserInfo ".$_SESSION['userGoogleDriveId']);
